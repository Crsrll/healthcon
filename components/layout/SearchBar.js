export default function SearchBar({ value, onChange, onClear, placeholder, className }) {
  return (
    <div className="relative w-full group">
      ...
      <input 
        ...
        className={`w-full pl-9 pr-4 py-2.5 border border-slate-200 rounded-xl text-sm outline-none transition-all ${className}`} 
      />
