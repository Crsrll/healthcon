...
import { Bell, Calendar, Clock, Star, Flag, MessageCircle, Check, CheckCheck, X, ChevronRight, Loader2 } from "lucide-react";
...
function NotifIcon({ type }) {
  ...
  switch (type) {
    ...
    case "new_review":
      return <div className={`${base} bg-yellow-500`}><Star size={18} /></div>;
