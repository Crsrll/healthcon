...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 overflow-x-hidden">
      ...
      <section className="bg-navy-dark text-white pt-20 sm:pt-32.5 pb-12 sm:pb-22.5">
        <div className="max-w-7xl mx-auto px-4 sm:px-12 grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 items-center">
          ...
          <div className="flex flex-col gap-4 sm:gap-6">
            ...
            <h1 className="animate-fadeSlideUp delay-250 font-bold leading-tight text-[36px] sm:text-[52px]">
            ...
            <div className="animate-[fadeSlideUp_0.7s_ease_both] delay-550 flex gap-3 flex-wrap pt-1">
              ...
              <button
                ...
                className="bg-[#2f80d0] text-white px-5 sm:px-7 py-3 rounded-[10px] font-bold text-[14px] sm:text-[15px]
              ...
              <button
                ...
                className="border border-white/25 text-white px-5 sm:px-7 py-3 rounded-[10px] font-bold text-[14px] sm:text-[15px]
                           transition-all duration-200
      ...
      {/* STATS */}
      <section className="bg-white border-b border-slate-100 py-12 sm:py-15">
        <div className="max-w-7xl mx-auto px-4 sm:px-12 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          ...
          {[
            ...
            <div key={stat.label} className="transition-transform hover:scale-[1.08]">
              <div className="font-bold text-navy-dark text-[28px] sm:text-[34px]">{stat.value}</div>
              <div className="text-slate-400 font-bold uppercase tracking-wide mt-1 text-[10px] sm:text-[12px]">
                {stat.label}
              </div>
            </div>
          ))}
      ...
      {/* WHY */}
      <section id="about" className="bg-white py-16 sm:py-22">
        <div className="max-w-7xl mx-auto px-4 sm:px-12 grid grid-cols-1 lg:grid-cols-3 gap-10 sm:gap-12">

          <div className="flex flex-col gap-3 sm:gap-4">
            <h5 className="font-bold text-blue-600 uppercase tracking-widest text-[11px]">
              Why HealthCon
            </h5>
            <h2 className="font-bold text-navy-dark leading-tight text-[28px] sm:text-[32px]">
              Healthcare that works around your life
            </h2>
            <p className="text-slate-500 leading-relaxed text-[14px] sm:text-[15px]">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
            ...
            {[
              ...
              <div
                key={item.title}
                className="border border-slate-100 rounded-2xl bg-slate-50 p-5 sm:p-7
                           transition-all duration-200
                           hover:-translate-y-1.5 hover:shadow-[0_16px_40px_rgba(18,40,68,0.12)]
                           hover:border-blue-200 hover:bg-white"
              >
                <div className="text-[22px] sm:text-[24px] mb-3 sm:mb-3.5">{item.icon}</div>
                <h4 className="font-bold text-[16px] sm:text-[17px] mb-2">{item.title}</h4>
                <p className="text-slate-500 text-[12px] sm:text-[13px] leading-relaxed">{item.desc}</p>
              </div>
            ))}
      ...
      {/* HOW IT WORKS */}
      <section id="how-it-works" className="bg-navy-dark text-white py-16 sm:py-22">
        <div className="max-w-7xl mx-auto px-4 sm:px-12">

          <div className="mb-8 sm:mb-13">
            <h5 className="font-bold text-blue-400 uppercase tracking-widest text-[11px] mb-2">
              How It Works
            </h5>
            <h2 className="font-bold text-[28px] sm:text-[34px] mb-2">Three steps to your doctor</h2>
            <p className="text-blue-200/50 text-[14px] sm:text-[15px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
            ...
            {[
              ...
              <div
                key={step.num}
                className="flex flex-col gap-3 p-5 sm:p-6 rounded-2xl
                           transition-all duration-200
                           hover:-translate-y-1 hover:bg-white/5"
              >
                <div className="font-bold text-white/10 text-[32px] sm:text-[36px]">{step.num}</div>
                <h3 className="font-bold text-[18px] sm:text-[20px]">{step.title}</h3>
                <p className="text-blue-100/40 text-[13px] sm:text-[14px] leading-relaxed">{step.desc}</p>
              </div>
            ))}
      ...
      {/* CTA */}
      <section className="bg-white text-center py-16 sm:py-25 px-4 sm:px-12">
        <div className="max-w-165 mx-auto flex flex-col gap-4 sm:gap-5.5">

          <h5 className="font-bold text-blue-600 uppercase tracking-widest text-[11px]">
            Get Started Today
          </h5>

          <h2 className="font-bold text-navy-dark text-[32px] sm:text-[46px] leading-tight">
            Your health can't wait.
          </h2>

          <p className="text-slate-400 text-[15px] sm:text-[17px] leading-relaxed px-2">
          ...
          <div className="pt-2">
            <button
              onClick={() => router.push("/auth/register")}
              className="bg-[#2f80d0] text-white px-7 sm:px-10 py-3.5 sm:py-4 rounded-xl font-bold text-[15px] sm:text-[17px]
