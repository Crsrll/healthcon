  ...
  return (
    <main className="max-w-7xl mx-auto px-6 py-8 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button className="bg-healthcon-blue hover:bg-blue-800 text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition-colors">Save Changes</button>
      </div>
        ...
        <div className="space-y-4">
          <section className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
            ...
            <div className="flex gap-2">
              <input placeholder="Add specialization..." className="flex-1 border border-slate-200 rounded-lg px-3 py-2 text-sm outline-none focus:border-teal-400 transition-colors" />
              <button className="bg-teal-500 hover:bg-teal-400 text-white text-sm font-bold px-3 py-2 rounded-lg transition-colors">+</button>
            </div>
          </section>
            ...
            <div className="space-y-2 mb-3">
              {['General Consultation', 'Laboratory Services', 'Minor Surgery'].map(s => (
                <div key={s} className="flex items-center justify-between text-sm py-1.5 border-b border-slate-50 last:border-0">
                  ...
                  <button className="text-slate-300 hover:text-red-400 transition-colors text-xs">Remove</button>
                </div>
              ))}
            </div>
            <div className="flex gap-2">
              <input placeholder="Add service..." className="flex-1 border border-slate-200 rounded-lg px-3 py-2 text-sm outline-none focus:border-teal-400 transition-colors" />
              <button className="bg-teal-500 hover:bg-teal-400 text-white text-sm font-bold px-3 py-2 rounded-lg transition-colors">+</button>
            </div>
          </section>
