        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
              ...
              <Link href="/clinic/schedule" className="text-xs font-semibold text-teal-600 hover:underline flex items-center gap-1">View Calendar</Link>
            </div>
          ...
          <section className="bg-healthcon-blue rounded-2xl p-5 text-white shadow-lg shadow-blue-900/20 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="space-y-2.5">
                ...
                <button className="w-full bg-white/10 hover:bg-white/20 border border-white/15 py-2.5 rounded-xl font-bold text-sm transition-all">Manage Schedule</button>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="divide-y divide-slate-50">
              {recentInquiries.map((inq) => (
                <div key={inq.id} className={`p-4 cursor-pointer transition-colors group ${inq.unread ? "hover:bg-teal-50/50" : "hover:bg-slate-50"}`}>
                  <div className="flex items-start gap-3">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-[10px] font-black shrink-0 ${inq.unread ? "bg-healthcon-blue text-white" : "bg-slate-100 text-slate-500"}`}>{inq.initials}</div>
                    <div className="flex-1 min-w-0">
                      ...
                      {inq.unread && <button className="mt-1.5 text-[10px] font-bold text-teal-600 hover:text-teal-500 uppercase tracking-wide">Reply →</button>}
                    </div>
            ...
            <div className="px-5 py-3 border-t border-slate-100 bg-slate-50/50">
              <button className="text-xs font-semibold text-slate-400 hover:text-teal-600 transition-colors w-full text-center">View All Inquiries →</button>
            </div>
          </section>
        </div>
      </div>
